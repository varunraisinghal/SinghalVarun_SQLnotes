...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    public DatabaseHelper(Context context)
    {
        ...
        Log.d("MyContactApp", "DatabaseHelper: DatabaseHelper Constructed");
    }

    @Override
    public void onCreate(SQLiteDatabase db)
    {
        Log.d("MyContactApp", "DatabaseHelper: Database created");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
    {
        ...
        Log.d("MyContactApp", "DatabaseHelper: Database upgraded");
        onCreate(db);
    }

    public boolean insertData(String name, String number, String address)
    {
        Log.d("MyContactApp", "DatabaseHelper: Data inserted");
